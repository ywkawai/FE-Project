...
\end{align}
%%
where $D_\lambda^\uparrow$ and $D_\lambda^\downarrow$ the diffusivity factors determined by the adopted angular quadrature,
...
\cite{Vallis2018} include the CO2 absorption in each band and changes the functional form of the non-window optical depth.
