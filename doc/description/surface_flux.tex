...
On the other hand, the surface momentum flux is calculated using a prescribed friction velocity $u_*$, 
which is related to the surface stress as follows:
%%
\begin{align}
...
and $C_m=$ is the drag coefficient defined as
%%
\begin{align}
...
The minimum and maximum values of the wind speed and $C_m$ can be limited to avoid numerical instability.
...
The minimum and maximum values of the wind speed can be limited to avoid numerical instability.
