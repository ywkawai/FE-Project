...
\begin{tabularx}{150mm}{|l|l|X|l|} \hline
 ...
 Linux OS x86-64 & Intel OneAPI   & Intel MPI & Makedef.Linux64-llvm-intel-impi \\ \cline{2-4}
                 & NVIDIA HPC SDK & CUDA-aware Open MPI & Makedef.Linux64-nvidia \\ \hline
...
\begin{tabularx}{150mm}{|l|X|} \hline
 ...
 SCALE\_ENABLE\_OPENACC   & Enable to use OpenACC \\ 
 NVIDIA\_GPU\_COMPATIBILITY & Compute capability of the target NVIDIA GPU used by NVIDIA HPC SDK. \\ \hline
