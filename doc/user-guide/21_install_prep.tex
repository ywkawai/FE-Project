...
\begin{tabularx}{150mm}{|l|X|} \hline
 \rowcolor[gray]{0.9} Name of compiler &  \\ \hline
  ...
  NVIDIA HPC SDK (nvcc/nvfortran) & Version 26.1 or later is supported. \\ \hline
\end{tabularx}
\label{tab:compatible_compiler}
\end{center}
\end{table}

When NVIDIA HPC SDK is used, OpenACC/GPU execution is available for selected sample programs and the regional dynamical-core calculation. 
This GPU support is still under development. Therefore, some SCALE-DG components, especially those related to physical processes, may still be executed on CPUs or may not yet support GPU execution.
