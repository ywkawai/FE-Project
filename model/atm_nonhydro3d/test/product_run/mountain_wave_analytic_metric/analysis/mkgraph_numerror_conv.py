...
linf_ylim = [1e-8,1e-1]
slope_Linf_list = {
  "o2": 1e4*(1.0/slope_dof)**2,
  "o3": 4e6*(1.0/slope_dof)**3,  
  "o4": 4e9*(1.0/slope_dof)**4,   
#  "o4_2": 1e6*(1.0/slope_dof)**4,   
  "o6": 1.2e13*(1.0/slope_dof)**6,
#  "o8": 2e18*(1.0/slope_dof)**8,
  "o9": 7e20*(1.0/slope_dof)**9,  
  "o12": 2e28*(1.0/slope_dof)**12}
...
#  "o7": 8e7*(1.0/slope_dof)**7,    
  "o8": 2.5e15*(1.0/slope_dof)**8,
...
#  "o3": 3.5e0*(1.0/slope_dof)**3,  
  "o4": 5e6*(1.0/slope_dof)**4,   
#  "o7": 8e7*(1.0/slope_dof)**7,    
  "o8": 3e16*(1.0/slope_dof)**8,
...
#  "o3": 2.5e2*(1.0/slope_dof)**3,      
  "o4": 1e9*(1.0/slope_dof)**4,   
  "o8": 1e19*(1.0/slope_dof)**8,
  "o9": 4e20*(1.0/slope_dof)**9,  
