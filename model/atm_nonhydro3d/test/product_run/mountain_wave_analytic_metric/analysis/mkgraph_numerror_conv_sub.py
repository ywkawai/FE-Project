...
def get_numerror_data(in_numerror_logfile, var_list):
  names=['dummy1', 'tsec' ]
  for v in var_list:
...
def get_numerror_data_list(dir, exp_list, analysis_data, var_list):
  list_numerror = {}
  for subdir in exp_list:
    list_numerror[subdir] = get_numerror_data(f"{dir}/{subdir}/{analysis_data}", var_list)
