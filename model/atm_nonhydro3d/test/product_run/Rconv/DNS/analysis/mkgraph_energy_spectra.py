...
exp_label_list = {
  ...
  "Dx6.3m_P3": "Δ=6.3m,P3", "Dx6.3m_P7": "Δ=6.3m,P7", "Dx6.7m_P11": "Δ=6.7m,P11", 
  "Dx3.1m_P7": "Δ=3.1m,P7", 
}
exp_color_list = {
...
exp_ltype_width = {
  ...
  "Dx6.3m_P3": 3, "Dx6.3m_P7": 3, "Dx6.7m_P11": 3, 
  "Dx3.1m_P7": 3, 
}
exp_ncut = {
...
for zind, zlev in enumerate(ZLEVEL_list):
  ...
  common.create_fig_energy_spectra_diff_refexp( ke_spectra_3dvel_list, K_EXP_NAME_LABEL, zlev, cr, 
                                             exp_ncut, exp_name_list, exp_label_list, exp_color_list, exp_ltype_list, exp_ltype_width,
