...
exp_info_common = {"ini_PT": "300.5D0",  "node_shape": "", "tb_filter_fac": "2D0", "const_hflx": "200D0",
                   "comp_comm_overlap": True, "StabCoef_bnd": "1D0" }
# p=3
exp_list_P3 = {
...
exp_list_P11 = {
  ...
  "Dx13m_P11": { "nprcx": 20, "nprcy": 20, "Ex": 1, "Ey": 1, "Ez": 10, "porder": 11, "dt_sec": "1.25D-1", "dt_dyn_sec": "1.25D-2", 
                  "runno_s": 3,  "start_time_sec" : 2*7200,                                                               
                  "integ_hour": 72, "hr_per_run": 2, "elapse_time": "01:45:00",
                  "modal_filter_flag": True, "mf_ordh": 32, "mf_alph": "1D-3", "mf_ordv": 32, "mf_alpv": "1D-3", 
                  "hist_int_sec": "900D0", "initgp_porder": 13, 
...
for exp_name, exp_info in exp_list.items():
  exp_info_ = copy.deepcopy(exp_info_common)
  exp_info_.update(exp_info)
  mkconf_sub.mk_conf_sh( exp_name, exp_info_, "" )
