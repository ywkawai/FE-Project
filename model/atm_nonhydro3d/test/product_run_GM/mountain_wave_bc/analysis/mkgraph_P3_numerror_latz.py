...
#---
conv_rate_=conv_rate.rolling(center=True,x=5).mean()
conv_rate_.coords["x"] = conv_rate_.coords["x"]*180/np.pi + 180
w_ref_ = w_ref.copy()
w_ref_.coords["x"] = w_ref_.coords["x"]*180/np.pi + 180
mkgraph( conv_rate_.sel(z=slice(60e3,72e3),x=slice(140,220)), 
         w_ref_.sel(z=slice(60e3,72e3),x=slice(140,220)),
         1.5, 4.5, 0.05,  0.5, 
...
mkgraph( numerror_w_.sel(z=slice(60e3,72e3),x=slice(140,220)), 
         w_ref_.sel(z=slice(60e3,72e3),x=slice(140,220)), 
