...
for var in DDENS QV QC QI QR QS QG ENGT ENGP ENGK ENGI; do
...
for time in 300 600 900 1200 1500 1800; do
   ...
   for qtrc in QC QI QR QS QG; do
      python ../../common/cmd_mkgraph.py history.pe00*.nc@${qtrc},y=16e3,time=${time} analysis/${qtrc}_y16km_t${time}s.png --prc_num_xy 5 2 --figsize 12 4
   done
done
