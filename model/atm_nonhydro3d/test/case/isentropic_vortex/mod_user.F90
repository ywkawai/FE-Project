...
module mod_user
  ...
  type, private, extends(experiment) :: Exp_isentropic_vortex
  contains 
    procedure :: setInitCond_lc => exp_SetInitCond_isentropic_vortex
    procedure :: geostrophic_balance_correction_lc => exp_geostrophic_balance_correction
  end type
  type(Exp_isentropic_vortex), private :: exp_manager
...
!OCL SERIAL
  subroutine exp_SetInitCond_isentropic_vortex( this,                      &
    ...
    class(Exp_isentropic_vortex), intent(inout) :: this
