...
program scaledg_init
  ...
  if( universal_master ) write(*,*) '*** Start Launch System for SCALE-DG_init'
  ...
  ! stop MPI
  call PRC_MPIfinish
  if( universal_master ) write(*,*) '*** End   Launch System for SCALE-DG_init'
