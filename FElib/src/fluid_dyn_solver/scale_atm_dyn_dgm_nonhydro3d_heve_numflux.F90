...
module scale_atm_dyn_dgm_nonhydro3d_heve_numflux
  ...
  public :: atm_dyn_dgm_nonhydro3d_heve_numflux_get_generalhvc_entot
...
!OCL SERIAL
  subroutine atm_dyn_dgm_nonhydro3d_heve_numflux_get_generalhvc_entot( &
    del_flux, del_flux_hyd,                                          & ! (out)
    DDENS_, MOMX_, MOMY_, MOMZ_, DRHOT_, DENS_hyd, PRES_hyd,         & ! (in)
    Rtot, CVtot, CPtot,                                              & ! (in)
    ...
    return
  end subroutine atm_dyn_dgm_nonhydro3d_heve_numflux_get_generalhvc_entot
