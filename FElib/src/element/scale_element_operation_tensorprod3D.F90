...
!!
!! @par Description
!!           A module for providing mathematical operations assuming a 3D tensor product element with (p+1)^3 DOF for GPU
!!
...
module scale_element_operation_tensorprod3D
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=1
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P1
    real(RP) :: D1D(2,2)
    real(RP) :: D1D_tr(2,2)
    real(RP) :: Lift_mat(2,2,2,6)
    real(RP) :: Lift_mat_tr(2,2,2,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=2
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P2
    real(RP) :: D1D(3,3)
    real(RP) :: D1D_tr(3,3)
    real(RP) :: Lift_mat(3,3,3,6)
    real(RP) :: Lift_mat_tr(3,3,3,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=3
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P3
    real(RP) :: D1D(4,4)
    real(RP) :: D1D_tr(4,4)
    real(RP) :: Lift_mat(4,4,4,6)
    real(RP) :: Lift_mat_tr(4,4,4,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=4
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P4
    real(RP) :: D1D(5,5)
    real(RP) :: D1D_tr(5,5)
    real(RP) :: Lift_mat(5,5,5,6)
    real(RP) :: Lift_mat_tr(5,5,5,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=5
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P5
    real(RP) :: D1D(6,6)
    real(RP) :: D1D_tr(6,6)
    real(RP) :: Lift_mat(6,6,6,6)
    real(RP) :: Lift_mat_tr(6,6,6,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=6
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P6
    real(RP) :: D1D(7,7)
    real(RP) :: D1D_tr(7,7)
    real(RP) :: Lift_mat(7,7,7,6)
    real(RP) :: Lift_mat_tr(7,7,7,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=7
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P7
    real(RP) :: D1D(8,8)
    real(RP) :: D1D_tr(8,8)
    real(RP) :: Lift_mat(8,8,8,6)
    real(RP) :: Lift_mat_tr(8,8,8,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=8
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P8
    real(RP) :: D1D(9,9)
    real(RP) :: D1D_tr(9,9)
    real(RP) :: Lift_mat(9,9,9,6)
    real(RP) :: Lift_mat_tr(9,9,9,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=9
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P9
    ...
    real(RP) :: Lift_mat_tr(10,10,10,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=10
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P10
    ...
    real(RP) :: Lift_mat_tr(11,11,11,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=11
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P11
    ...
    real(RP) :: Lift_mat_tr(12,12,12,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=12
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P12
    ...
    real(RP) :: Lift_mat_tr(13,13,13,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=13
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P13
    ...
    real(RP) :: Lift_mat_tr(14,14,14,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=14
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P14
    ...
    real(RP) :: Lift_mat_tr(15,15,15,6)
  ...
  !> Derived type for elementwise operations with 3D tensor product elements with polynomial order p=15
  type, public, extends(ElementOperationTensorProd3D) :: ElementOperationTensorProd3D_P15
    ...
    real(RP) :: Lift_mat_tr(16,16,16,6)
...
!OCL SERIAL
  subroutine ElementOperationTensorprod3D_create( elem3D, obj )
    ...
    implicit none
    class(ElementBase3D), intent(in) :: elem3D                           !< A 3D element object whose polynomial order is used to determine the type of created object
    class(ElementOperationTensorProd3D), intent(out), allocatable :: obj !< Created object of ElementOperationTensorProd3D
    !-----------------------------------------------------
...
!OCL SERIAL
  subroutine element_operation_tensorprod3D_Init_P1( this, elem3D )
    use scale_element_operation_base, only: ELEMENT_OPERATOR_TYPE_TENSORPROD3D
    implicit none
    ...
    this%elem3D => elem3D
    this%operator_type = ELEMENT_OPERATOR_TYPE_TENSORPROD3D
    
    call setup_elem_operator( this%D1D, this%D1D_tr, this%Lift_mat, this%Lift_mat_tr, this%IntrpMat_VPOrdM1_tr, &
      2, elem3D )
    !$acc enter data copyin( this )
    !$acc enter data attach( this%elem3D )
...
!OCL SERIAL
  subroutine element_operation_tensorprod3D_Setup_ModalFilter_P1( this, &
    ...
    !$acc update device( this%MFilter_h1D, this%MFilter_h1D_tr, this%MFilter_v1D_tr )
    return
...
!OCL SERIAL
  subroutine element_operation_tensorprod3D_Setup_ModalFilter_tracer_P1( this, &
    ...
    call setup_ModalFilter( this%MFilter_tracer_h1D, this%MFilter_tracer_h1D_tr, this%MFilter_tracer_v1D_tr, &
      ...
      MF_ETAC_v, MF_ALPHA_v, MF_ORDER_v,               &
      this%elem3D%PolyOrder_h, this%elem3D%PolyOrder_v )
    !$acc update device( this%MFilter_tracer_h1D, this%MFilter_tracer_h1D_tr, this%MFilter_tracer_v1D_tr )
    return
...
!OCL SERIAL
  subroutine setup_elem_operator( D1D, D1D_tr, Lift_mat, Lift_mat_tr, IntrpMat_VPOrdM1_tr, &
    np, elem3D )
    use scale_element_line, only: LineElement
    ...
    real(RP), intent(out) :: Lift_mat_tr(6,np,np,np)
    ...
    do i=1, np
      ...
      Lift_mat(i,j,k,1:6) = Lift_mat_tr(1:6,i,j,k)
    end do
    end do
    end do
    call Lift_sm%Final()
