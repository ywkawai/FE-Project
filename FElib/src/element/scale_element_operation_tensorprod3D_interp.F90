...
module scale_element_operation_tensorprod3d_interp
  ...
  type, public :: ElementOptrTensorProd3DInterp
  ...
  contains
    procedure :: Init => ElementOptrTensorProd3DInterp_Init
    procedure :: Final => ElementOptrTensorProd3DInterp_Final
    procedure :: do_GLL2GL => ElementOptrTensorProd3DInterp_gll2gl
    procedure :: do_GL2GLL => ElementOptrTensorProd3DInterp_gl2gll
  end type ElementOptrTensorProd3DInterp
...
!OCL SERIAL
  subroutine ElementOptrTensorProd3DInterp_Init( this, elem, PolyOrder_h_ip )
    ...
    r_int1D_i(:) = Polynomial_GenGaussLegendrePt( this%NnodeH1D_GL )
    r_int1Dw_i(:) = Polynomial_GenGaussLegendrePtIntWeight(this%NnodeH1D_GL )
    P_int1D_ori_h(:,:) = Polynomial_GenLegendrePoly( elem%PolyOrder_h, r_int1D_i )
    ...
    P1D_gl_h(:,:) = Polynomial_GenLegendrePoly( Polyorder_h_ip, r_int1D_i )
    P1D_gll_h(:,:) = Polynomial_GenLegendrePoly( Polyorder_h_ip, elem1D%x1 )
    ...
    call elem1D%Final()
    return
  end subroutine ElementOptrTensorProd3DInterp_Init

!OCL SERIAL
  subroutine ElementOptrTensorProd3DInterp_Final( this )
    implicit none
    class(ElementOptrTensorProd3DInterp), intent(inout) :: this
    !----------------------------------------
    ...
    return
  end subroutine ElementOptrTensorProd3DInterp_Final

!OCL SERIAL
  subroutine ElementOptrTensorProd3DInterp_gll2gl( this, q, q_intrp )
    implicit none
    class(ElementOptrTensorProd3DInterp), intent(in) :: this
    ...
    return
  end subroutine ElementOptrTensorProd3DInterp_gll2gl

!OCL SERIAL
  subroutine ElementOptrTensorProd3DInterp_gl2gll( this, q, q_intrp )
    implicit none
    class(ElementOptrTensorProd3DInterp), intent(in) :: this
    ...
    return
  end subroutine ElementOptrTensorProd3DInterp_gl2gll
...
end module scale_element_operation_tensorprod3d_interp
