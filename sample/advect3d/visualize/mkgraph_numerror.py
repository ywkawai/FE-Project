...
mkgraph_numerror( time, ds["L2_error"], 'L2 error', "L2 error", 1e-7, 1e0, f"{outpng_basename}_l2.png")
mkgraph_numerror( time, ds["Linf_error"], 'Linf error', "Linf error", 1e-6, 1e1, f"{outpng_basename}_linf.png")
