...
from advect2d_fvm_expcase import exp_prepair

TOP_DIR="./"
Ne_List = [4, 8, 16, 32, 64, 128, 256, 512]
FluxScheme_List = ['CD2', 'UD3', 'CD4']
DELT_List = [ [0.0005]*len(Ne_List) ]*len(FluxScheme_List) 

ORG_PE_PATH="/data5/ykawai/FE-Project/sample/advect2d_fvm/test_advect2d"
...
exp_prepair(TOP_DIR, Ne_List, FluxScheme_List, DELT_List, ORG_PE_PATH, expcase_params_dict)
